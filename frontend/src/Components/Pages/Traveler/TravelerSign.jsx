...
const TravelerSign = () => {
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      const response = await fetch('https://travel-guide-fyp.duckdns.org/api/traveler/signup', {
        method: 'POST',
        headers: {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      const response = await fetch('https://travel-guide-fyp.duckdns.org/api/traveler/login', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
